...
#define akw_function_value(f) ((AkwValue) { .type = AKW_TYPE_FUNCTION, .flags = AKW_FLAG_OBJECT, .asPointer = (f) })
...
#define akw_as_function(v) ((AkwFunction *) (v).asPointer)
...
#define akw_is_function(v) (akw_type(v) == AKW_TYPE_FUNCTION)
