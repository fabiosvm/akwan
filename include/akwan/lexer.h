...
typedef enum
{
  ...
  AKW_TOKEN_KIND_RBRACE,    AKW_TOKEN_KIND_AMP,      AKW_TOKEN_KIND_EQ,        AKW_TOKEN_KIND_PLUS,
  ...
  AKW_TOKEN_KIND_FALSE_KW,  AKW_TOKEN_KIND_INOUT_KW, AKW_TOKEN_KIND_LET_KW,    AKW_TOKEN_KIND_NIL_KW,
