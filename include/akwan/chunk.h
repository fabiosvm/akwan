...
#define akw_nil_instr(d)          (akw_instr_fmt1(AKW_OP_NIL, (d)))
#define akw_false_instr(d)        (akw_instr_fmt1(AKW_OP_FALSE, (d)))
#define akw_true_instr(d)         (akw_instr_fmt1(AKW_OP_TRUE, (d)))
#define akw_const_instr(d, idx)   (akw_instr_fmt2(AKW_OP_CONST, (d), (idx)))
