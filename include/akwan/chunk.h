...
typedef enum
{
  ...
  AKW_OP_POP,              AKW_OP_GET_LOCAL,
  AKW_OP_SET_LOCAL,        AKW_OP_GET_LOCAL_BY_REF,
  AKW_OP_SET_LOCAL_BY_REF, AKW_OP_GET_ELEMENT,
  AKW_OP_ADD,              AKW_OP_SUB,
  AKW_OP_MUL,              AKW_OP_DIV,
  AKW_OP_MOD,              AKW_OP_NEG,
  AKW_OP_RETURN
} AkwOpcode;
