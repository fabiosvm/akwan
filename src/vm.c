...
static void do_set_element(AkwVM *vm, AkwChunk *chunk, uint8_t *ip, AkwValue *slots);
...
static AkwInstructionHandleFn instructionHandles[] = {
  ...
  [AKW_OP_SET_LOCAL] = do_set_local, [AKW_OP_GET_ELEMENT] = do_get_element, [AKW_OP_SET_ELEMENT] = do_set_element,
